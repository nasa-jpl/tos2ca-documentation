...
- Access to AWS services the resources file in at docs/Resources.md

## Library Flow

Below is a description of the various TOS2CA stages.  You should also take a look at the job statuses file in docs/Statuses.md for additional information.  
...
7. Deposit the ForTraCC output into Elasticache.
8. Stitch the output netCDF-4 file together and deposit it in S3.
9. Create plots and GeoJSON polygons of the anomalies.
10. Upload the plots and GeoJSON to S3.
11. E-Mail the user that their job is complete and send them the locatin of the S3 bucket with their job directory.
12. Mark the job as ``'complete'`` in the database.
