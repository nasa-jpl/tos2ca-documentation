...
- FastAPI for Python
- Access to the TOS2CA MySQL database
- See the repo's requirements.txt file for additional dependencies
...
1. The API endpoints in `/api/main.py` need to be running for the visualization tool (in `tos2ca-data-access-server`) to work.
