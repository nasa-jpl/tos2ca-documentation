...
Basically, TOS2CA can help users research why a phenomenon developed as it did vs. any other phenomonon of the same type.
...
1) delineate storms (from Program of Record, e.g. geostationary IR), 
...
- Python-based 
- modular (you can easily drop in new data readers or phenomenon detection algorithms)
- cloud-native
